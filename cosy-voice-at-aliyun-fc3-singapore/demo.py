...
for i, j in enumerate(cosyvoice.inference_zero_shot('景元，你好。十四年前我创办小米的时候,讲过一句话。我说当台风来的时候连猪都会飞,讲的是大家有像猪一样的态度,你就可以成功。把握机遇的重要性非常重要。', '希望你以后能够做的比我还好呦。', prompt_speech_16k, stream=False)):
